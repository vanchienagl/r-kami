...
<body id="pageTop">
  ...
  <main id="mainWrap" class="p-top active">
    <!-- ____________________content____________________ -->

    <div class="bg-fixed js-bg-top">
      <picture class="bg" id="bg01">
      ...
      <div class="bg" id="bg02">
        <div class="fixed-title" id="js_split_title">
          <h2 class="title">譲れない正統。</h2>
        </div>
        <div class="bg03" id="bg03"></div>
        <img id="bg02_img" loading="lazy" src="<?php echo h($path_img); ?>/top/bg_intro_1.jpg" alt="譲れない正統。">
      </div>

      <div class="bg" id="bg04">
    ...
    <section class="sec-p sec-p-access sec--full js-submenu-sec" id="sec04">
      <div class="com-wrap wrap">
        <div class="content">
          ...
          <div class="info">
            <p class="desc m_down">都心直結、駅徒歩5分にして、<br>第一種低層住居専用地域の<br>正統なる地 。</p>
            <div class="buttons m_down">
              <a href="#" class="button">
    ...
    <section class="sec-p sec-p-design sec--full js-submenu-sec" id="sec05">
      <div class="com-wrap wrap">
        <div class="content">
          <div class="image m_down">
          ...
          <div class="info">
            <p class="desc m_down">気高き風格と美しき品格を<br>兼ね備えた、<br>全106邸の低層レジデンス。</p>
            <div class="buttons m_down">
              <a href="#" class="button">
    ...
    <section class="sec-p sec-p-garden sec--full js-submenu-sec" id="sec06">
      <div class="com-wrap wrap">
        <div class="content">
          <div class="image m_down">
          ...
          <div class="info">
            <p class="desc m_down">広大な敷地を活かし<br>森林浴ができる<br>本格的な森の庭を創造。</p>
            <div class="buttons m_down">
              <a href="#" class="button">
                <span class="f-cormorant text">DESIGN</span>
                <span class="arrow"><img src="<?php echo h($path_img); ?>/common/icon_arrow_2.svg" alt="arrow"></span>
    ...
    <section class="sec-p sec-p-quality sec--full js-submenu-sec" id="sec07">
      <div class="com-wrap wrap">
        <div class="content">
          <div class="image m_down">
          ...
          <div class="info">
            <p class="desc m_down">省エネ性の高い<br>認定低炭素レジデンス</p>
            <div class="buttons m_down">
    ...
    <section class="sec-p sec-p-plan sec--full js-submenu-sec" id="sec08">
      <div class="com-wrap wrap">
        <div class="content">
          <div class="image m_down">
          ...
          <div class="info">
            <p class="desc m_down">先進の構法による<br>ハイサッシなど<br>やさしい光をとり入れる工夫。</p>
            <div class="buttons m_down">
              <a href="#" class="button">
